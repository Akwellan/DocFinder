...
public class main extends javax.swing.JFrame {
    ...
    public main() {
        ...
        try {
            RecupFichier.create();
            RecupFichier.setCurrentSoftware("Technique", "main");
    ...
    private void initComponents() {
        ...
        jLabel7.setText("MODE TECHNIQUE");
        ...
        jPanel9.setBackground(new java.awt.Color(222, 234, 240));
        ...
        jLabel20.setText("- Pour indexer, sélectionner le ou les fichiers à indexer (Touche Ctrl pour multisélection) puis ");

        jLabel21.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel21.setText("choisissez les critères.");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel20, javax.swing.GroupLayout.PREFERRED_SIZE, 837, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 837, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                if (files != null && files.length > 0){
                    ...
                    if (files.length !=1){
                        ...
                        for (File file : files) {
                            ...
                            //System.out.printlnfilenames "+filenames);
                            
                            filepath = file.getPath();
                            //System.out.printlnfilepath "+filepath);
                            try {
                                stm=conn.obtenirconnexion().createStatement();
                                ResultSet Rs = stm.executeQuery("SELECT COUNT(*) FROM `bddmaintenance` WHERE `fichier` = '"+filenames+"'");
                                while(Rs.next()) {
                                ...
                                if (nb==0) {
                                    ...
                                    filenames = filenames.replaceAll("\\\\'", "\'");
                                    cheminse=cheminse.replaceAll("\\\\", "/");
                                    //System.out.printlncheminse "+cheminse);
                                    tableauindex.addRow(new Object []{filenames, cheminse});
                        ...
                        }else if (files.length!=COUNT_INDEXER){
                            ////System.out.printlnCertains des fichiers séléctionner ont déja été indexer");
                            int messageType = 0;
                            JOptionPane.showMessageDialog(null, "Certain des fichiers séléctionner ont déja été indexer", "Indexer des fichiers", messageType);
...
OpenFile("I:\\Maintenance\\DocFinder\\DocFinder JAVA\\DocFinder\\DFprod.jar")   ;
this.dispose();          // TODO add your handling code here:
    ...
    private void afficher(){
        try {
            model.setRowCount(0);
        stm=conn.obtenirconnexion().createStatement();
        ResultSet Rs=stm.executeQuery("Select * from bddmaintenance");
        while(Rs.next()){
        model.addRow(new Object[]{Rs.getString("fichier"),Rs.getString("chemin"),Rs.getString("service"),Rs.getString("Type_de_document_N1"),Rs.getString("Type_de_document_N2"),Rs.getString("Type_de_document_N3"),Rs.getString("Lieu_Archivage"),Rs.getString("Type_de_Materiel"),Rs.getString("Constructeur"),Rs.getString("Materiel"),Rs.getString("Atelier"),Rs.getString("GFH_Lignes"),Rs.getString("Machines"),Rs.getString("Sous_ensemble"),Rs.getString("Annees")});
